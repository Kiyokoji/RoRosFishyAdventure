...
{
    [Title("Connecting Stars")] [InfoBox("Star 1 will be connected with Star 2", InfoMessageType.None)] [ReadOnly]
    public Star star1;

    [ReadOnly] public Star star2;
    ...
    [InfoBox("This is a reference to the actual collider. The Edge Collider in this GameObject is merely a trigger used to determine from where to where the collider should form.",
        InfoMessageType.None)]
    [HideInPlayMode]
    [SerializeField]
    private EdgeCollider2D edgeCollider;

    private bool IsEdgeColliderUsed()
    {
        return !(edgeCollider != null);
    }
    ...
    public ClusterPart clusterPart;
    ...
    public void UpdateActiveColliderSpace(Vector2?[] points, List<Star> starsLit)
    {
        ...
        */
        ...
        // 0 and 1 dont hit
        if (points[0] == null && points[1] == null && starsLit.Count == 0)
        {
            Debug.Log("lol");
            edgeCollider.enabled = false;
            return;
